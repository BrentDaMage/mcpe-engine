...
bool DepthStencilStateOGL::bindDepthStencilState(RenderContext& context, bool force)
{
    ...
    {
        glStencilFuncSeparate(GL_FRONT, m_frontFaceStencilInfo.func, m_description.stencilRef, m_stencilReadMask);
        glStencilFuncSeparate(GL_BACK, m_backFaceStencilInfo.func, m_description.stencilRef, m_stencilReadMask);
    ...
    {
        glStencilOpSeparate(GL_FRONT, m_frontFaceStencilInfo.stencilFailAction, m_frontFaceStencilInfo.stencilPassDepthFailAction, m_frontFaceStencilInfo.stencilPassDepthPassAction);
    ...
    {
        glStencilOpSeparate(GL_BACK, m_backFaceStencilInfo.stencilFailAction, m_backFaceStencilInfo.stencilPassDepthFailAction, m_backFaceStencilInfo.stencilPassDepthPassAction);
